...
namespace FA.JustBlog.Core.Repositories
{
    public class PostRepository : GenericRepository<Post>, IPostRepository
    {
        ...
        {
            var post =
                base.Context.Posts.Include("Category").SingleOrDefault<Post>(p => p.Published && p.PostedOn.Year == year && p.PostedOn.Month == month && p.UrlSlug == urlSlug);
            return post;
        }

        public IList<Post> GetAllPosts()
        {
            return base.Context.Posts.ToList();
        }
